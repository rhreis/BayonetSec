# BayonetSec Web Frontend

The frontend application for BayonetSec, a professional offensive security management platform.
...
This project is part of the BayonetSec platform. See the main project for licensing information.
