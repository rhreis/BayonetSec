...
namespace ScarletSec.Infrastructure.Data.DbContext;

public class ScarletSecDbContext : Microsoft.EntityFrameworkCore.DbContext
{
    ...
    public ScarletSecDbContext(DbContextOptions<ScarletSecDbContext> options) : base(options) { }
